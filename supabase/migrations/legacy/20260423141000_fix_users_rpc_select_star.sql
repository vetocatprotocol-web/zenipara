-- ============================================================
-- Fix remaining query/result type mismatches in users RPCs.
-- Replaces `SELECT u.*` with explicit column lists so Postgres
-- never has to reconcile table rowtype changes against RETURNS TABLE.
-- ============================================================
