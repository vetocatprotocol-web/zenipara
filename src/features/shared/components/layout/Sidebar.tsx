...
const ADMIN_NAV: NavItem[] = [
  ...
  { path: ROLE_ROUTE_PATHS.admin_satuan.documents,       label: 'Dokumen',        icon: 'FileText' },
  { path: ROLE_ROUTE_PATHS.admin_satuan.announcements,   label: 'Pengumuman',     icon: 'Megaphone' },
  { path: ROLE_ROUTE_PATHS.admin_satuan.schedule,        label: 'Jadwal Shift',   icon: 'CalendarDays' },
  { path: ROLE_ROUTE_PATHS.admin_satuan.attendance,      label: 'Rekap Absensi',  icon: 'ClipboardCheck' },
  { path: ROLE_ROUTE_PATHS.admin_satuan.apel,            label: 'Apel Digital',   icon: 'Bell' },
...
const NAV_ITEMS: Record<string, NavItem[]> = {
  ...
  staff_satuan: [
    ...
    { path: ROLE_ROUTE_PATHS.admin_satuan.apel,          label: 'Apel Digital',    icon: 'Bell' },
    { path: ROLE_ROUTE_PATHS.admin_satuan.kegiatan,      label: 'Kalender Kegiatan', icon: 'CalendarDays' },
    { path: ROLE_ROUTE_PATHS.staff_satuan.leaveReview,    label: 'Izin Personel',   icon: 'UserCheck' },
    { path: ROLE_ROUTE_PATHS.staff_satuan.laporanOps,     label: 'Laporan Ops',     icon: 'FileText' },
    { path: ROLE_ROUTE_PATHS.staff_satuan.sprint,         label: 'Surat Perintah',  icon: 'ScrollText' },
    { path: ROLE_ROUTE_PATHS.admin_satuan.schedule,      label: 'Jadwal Shift',    icon: 'CalendarDays' },
    { path: ROLE_ROUTE_PATHS.admin_satuan.logistics,     label: 'Logistik',        icon: 'Package' },
    { path: ROLE_ROUTE_PATHS.komandan.tasks,      label: 'Tugas',           icon: 'CheckSquare' },
    { path: ROLE_ROUTE_PATHS.admin_satuan.posJaga,       label: 'Pos Jaga',        icon: 'MapPin' },
    { path: ROLE_ROUTE_PATHS.staff_satuan.messages,       label: 'Pesan',           icon: 'Megaphone' },
  ],
};
